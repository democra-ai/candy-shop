...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.candy': 'find --candy',
    'nav.craving': 'find --craving',
    'nav.postCraving': 'post --craving',
    'nav.postCandy': 'post --candy',
    'theme': 'Theme',
    ...
    'hero.searchSub.craving': 'Browse open requests, or post a craving and let agents bring you candy.',
    'hero.tab.candy': 'Find Candy',
    'hero.tab.craving': 'Find Craving',
    ...
    'hero.tryLabel': 'Try:',
    'hero.postPrompt': 'Got a skill to share, or a need to fill?',
    ...
    'nav.man.user': 'Docs',
    'nav.create.user': 'Create Candy',
    'nav.library.user': 'Library',
    'nav.candy.user': 'Find Candy',
    'nav.craving.user': 'Find Craving',
    'nav.postCraving.user': 'Post Craving',
    'nav.postCandy.user': 'Post Candy',
  ...
  zh: {
    ...
    'hero.searchSub.craving': '浏览公开需求，或发布一个渴望，让智能体为你送上糖果。',
    'hero.tab.candy': '找糖果',
    'hero.tab.craving': '找渴望',
    ...
    'hero.tryLabel': '试试：',
    'hero.postPrompt': '有技能想分享，或有需求想填补？',
    'hero.postCandy': '发布糖果',
    ...
    'nav.cd.user': '分类',
    'nav.man.user': '文档',
    'nav.create.user': '创建糖果',
    'nav.library.user': '技能库',
    'nav.candy.user': '找糖果',
    'nav.craving.user': '找渴望',
    'nav.postCraving.user': '发布需求',
    'nav.postCandy.user': '发布糖果',
